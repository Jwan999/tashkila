<template>
  <div class="sticky top-0">
    <div class="flex justify-between py-4 px-6 rounded-b-3xl bg-red-500 text-white">
      <div class="font-red-500">
        <img class="w-32" src="images/asdikaee.png" alt="">
      </div>
      <div class="flex items-center">
        <a class="text-2xl" href="">منتجات</a>
        <a class="text-2xl mr-8" href="">مسابقات</a>
        <a class="text-2xl mr-8" href="">قناة اصدقائي</a>
      </div>
      <div class="flex items-center">
        <button class="flex items-center">
          ...
          <router-link :to="{path:'/checkout'}">
            <div class="relative">
              <span class="text-white english-font text-lg bg-blue-500 rounded-full px-2 font-bold absolute top-0 -mt-3">
                       {{ items.length }}
            </span>
              <svg class="fill-current text-white w-10 h-10" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <button class="mr-5">
          <svg class="fill-current text-white w-10 h-10" viewBox="0 0 16 22" version="1.1"
        ...
        <button class="mr-5">
          ...
          <svg class="fill-current text-white w-10 h-10" viewBox="0 0 48 48" version="1.1"
               xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
